...
class WorkflowTests(unittest.TestCase):
    ...
    def test_governance_workflows_are_read_only_nonblocking_and_retained(self) -> None:
        ...
        supportability_block, delivery_block = workflows["supportability-enforcement.yml"].split("  delivery-receipt:", 1)
        self.assertNotIn("supportability-artifact-id", supportability_block)
