...
class WorkflowTests(unittest.TestCase):
    ...
    def test_governance_workflows_are_read_only_nonblocking_and_retained(self) -> None:
        ...
        self.assertIn("issue_comment:", workflows["supportability-enforcement.yml"])
        self.assertIn("issues: read", workflows["supportability-enforcement.yml"])
        self.assertIn("rerun-supportability-on-evidence:", workflows["supportability-enforcement.yml"])
        self.assertIn("Rerun latest failed PR-head supportability", workflows["supportability-enforcement.yml"])
        self.assertIn("governance-review-evidence:v1", workflows["supportability-enforcement.yml"])
        self.assertIn("actions: write", workflows["supportability-enforcement.yml"])
        self.assertIn("rerun-failed-jobs", workflows["supportability-enforcement.yml"])
        self.assertIn("head_sha", workflows["supportability-enforcement.yml"])
