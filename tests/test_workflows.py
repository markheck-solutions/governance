...
class WorkflowTests(unittest.TestCase):
    ...
    def test_governance_workflows_are_read_only_nonblocking_and_retained(self) -> None:
        ...
        self.assertNotIn("Baseline Bootstrap Receipt Required", workflows["supportability-enforcement.yml"])
        self.assertNotIn("baseline protected workflow missing on main", workflows["supportability-enforcement.yml"])
        ...
        delivery_block = workflows["supportability-enforcement.yml"].split("  delivery-receipt:", 1)[1]
